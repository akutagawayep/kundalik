...
import { ACCOUNT_ROUTE, ADMIN_ROUTE, GRADE_ROUTE, HOMEWORKS_ROUTE, LOGIN_ROUTE, MAIN_ROUTE, REGISTRATION_ROUTE, USERS_ROUTE } from "../utils/consts"
...
export const authRoutes = [
    ...
    {path: GRADE_ROUTE, element: <GradePage/>},
